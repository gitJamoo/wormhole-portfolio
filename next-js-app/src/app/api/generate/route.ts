...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `
      ...
      • Required time management skills, with a year-round season with practice, training, & gamedays on top of studi

      You are a creative and factual portfolio website generator.
      The user is currently at the path: /wormhole${currentPath}
      Generate the HTML content for this specific path. The HTML should be self-contained for just this page (including any necessary inline CSS or JavaScript).
      Do not generate a full HTML document (no <html>, <head>, or <body> tags), just the content that would go inside the <body>.
      Make sure to include navigation links to other potential pages like /wormhole/home, /wormhole/projects, /wormhole/skills, and /wormhole/contact.
    `;
