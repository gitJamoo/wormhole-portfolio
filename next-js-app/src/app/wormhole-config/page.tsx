    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <p className="text-lg text-center sm:text-left max-w-xl">
          This page allows you to configure the settings for the wormhole.
          More options will be available here soon.
        </p>

        <div className="flex flex-col gap-4 w-full max-w-xl">
          <label htmlFor="system-instructions" className="text-lg font-medium">Additional System Instructions:</label>
          <textarea
